	...
	var OpAjax = $.ajax({
		...
		success: function (responseText) {
			...
			console.log(Respuesta)
				...
				var numlott=datos[5];
				var manz=datos[6];
				var idloteamiento=datos[7];
				var loteamiento=datos[8];
				
                  
 mapboxgl.accessToken = 'pk.eyJ1Ijoicm9sYW5kLTk1IiwiYSI6ImNqN2dzMmViazFiOWszM280OGlud2c0dnEifQ.OeRNcqHuL7fHI9VCY_Yk8A';
